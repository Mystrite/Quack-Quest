...
button_icons = {
    "green_forward" : pygame.image.load('./assets/GreenArrow.png'),
    "grey_forward"  : pygame.image.load('./assets/GreyedGreenArrow.png')
}

tile_icons = [None] * len(wfc.TILE_ID)
for id in range(len(wfc.TILE_ID)):
    tile_icons[id] =  pygame.image.load('./assets/TILE_%s_placeholder.png' % id)
...
class player:
    def __init__(self):
        ...
        self.direction = "UP"
        self.icons = {
            "UP" : pygame.image.load('./assets/Duck_UP.png'),
            "DOWN" : pygame.image.load('./assets/Duck_DOWN.png'),
            "LEFT" : pygame.image.load('./assets/Duck_LEFT.png'),
            "RIGHT" : pygame.image.load('./assets/Duck_RIGHT.png')
        }
...
def main_menu():
    ...
    while running:
        ...
        win.fill((0,190,255))
        drawtext("Quack Quest", fonts["comicsans_small"], (255,255,255), win, SWIDTH*0.425, SHEIGHT*0.1)
